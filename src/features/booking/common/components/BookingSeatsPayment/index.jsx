...
function BookingSeatsPayment({ movieInfo, userProfile, toLastStepper }) {
  // useDispatch
  ...
  const renderBasicModal = () => {
    ...
    const { hinhAnh, tenPhim, tenCumRap, diaChi, ngayChieu, gioChieu, tenRap } =
      movieInfo;
    ...
    return (
      <Container maxWidth="sm" className="basicModalPayment">
        ...
        <Box className="bookingActions">
          ...
          <Button onClick={handleOnclickCombackHome}>Quay về trang chủ</Button>
        </Box>
      </Container>
    );
  };
